  ...
  return (
    <div className="container mx-auto lg:px-4 px-2 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-viking-700 p-3 rounded-full lg:hidden text-viking-50 shadow-md hover:bg-viking-800 transition-colors flex justify-center items-center">
          <SvgSearch />
        </button>
      </div>

      <div className="mb-8">
        <h2 className="text-xl font-semibold text-viking-900 mb-2">
          Add New Patient
        </h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                ...
                <input
                  id="firstName"
                  className="border border-viking-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-viking-500 focus:border-transparent transition-all duration-200"
                  {...register("firstName")}
                />
              </div>
              <div className="flex flex-col">
            ...
            <button
              type="submit"
              className="bg-viking-700 text-white py-1 lg:py-2 rounded-md flex justify-center items-center space-x-3 hover:bg-viking-800 transition-colors w-full font-semibold"
            >
              <div className="flex justify-center items-center">
                <SvgUserplus className="text-viking-50 " />
              </div>
              <span>Add User</span>
            </button>
          </form>
